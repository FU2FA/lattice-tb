...
export function octahedralTwoSublatticeLattice(): Lattice {
  return {
    id: "octahedral2",
    name: "Octahedral two-sublattice",
    dim: 3,
    a: [0, 0.5, 0.5],
    b: [0.5, 0, 0.5],
    c: [0.5, 0.5, 0],
    ...
    visualSites: [
      ...
      { id: 4, element: "B", position: [0.5, 0, 0], type: "B", color: 0xf97316 },
      { id: 5, element: "B", position: [0, 0.5, 0], type: "B", color: 0xf97316 },
      { id: 6, element: "B", position: [0, 0, 0.5], type: "B", color: 0xf97316 },
      { id: 7, element: "B", position: [0.5, 0.5, 0.5], type: "B", color: 0xf97316 },
    ],
    highSymmetry: {
