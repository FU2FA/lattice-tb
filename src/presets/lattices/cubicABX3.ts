...
export function cubicABX3Lattice(): Lattice {
  return {
    id: "cubic_abx3",
    name: "Cubic ABX3",
    dim: 3,
    ...
    sites: [
      ...
      { id: 2, element: "X", position: [0.5, 0.5, 0], type: "X", color: 0x22c55e },
      { id: 3, element: "X", position: [0.5, 0, 0.5], type: "X", color: 0x22c55e },
      { id: 4, element: "X", position: [0, 0.5, 0.5], type: "X", color: 0x22c55e },
    ],
    highSymmetry: {
