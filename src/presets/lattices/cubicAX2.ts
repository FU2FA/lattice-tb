...
export function cubicAX2Lattice(): Lattice {
  return {
    id: "cubic_ax2",
    name: "Cubic AX2",
    dim: 3,
    ...
    sites: [
      ...
      { id: 1, element: "X", position: [0.25, 0.25, 0.25], type: "X", color: 0xf97316 },
      { id: 2, element: "X", position: [0.75, 0.75, 0.75], type: "X", color: 0xf97316 },
    ],
    highSymmetry: {
